...
export default async function AdminDashboard() {
  const [
    ...
    client.fetch<number>(`count(*[_type == "client" && status != "demo"])`),
    client.fetch<number>(`count(*[_type == "client" && status == "active"])`),
    client.fetch<number>(`count(*[_type == "client" && status == "paused"])`),
    client.fetch<number>(`count(*[_type == "client" && plan == "Silver" && status != "demo"])`),
    client.fetch<number>(`count(*[_type == "client" && plan == "Gold" && status != "demo"])`),
    client.fetch<number>(`count(*[_type == "client" && plan == "Premium" && status != "demo"])`),
